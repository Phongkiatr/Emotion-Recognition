        ...
        if frame_counter % 2 == 0:
            ...
            for (x, y, w, h) in faces:
                ...
                if predicted_emotion == 'happy' and last_predicted_emotion != 'happy':
                    countdown = 3  # เริ่มนับถอยหลัง 3 วินาที
...
# ตั้งค่าการจับภาพในอัตรา FPS ที่สูงขึ้น
cap.set(cv2.CAP_PROP_FPS, 120)# กำหนด FPS เป็น 30 (หากกล้องรองรับ)
